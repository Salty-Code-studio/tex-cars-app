...
const all = [
  ...
  bookingConfirmedEmail({ vehicleName: "Hyundai Creta", startAt, endAt, rentalTotalCents: 34800, amountPaidCents: 4000, chargeType: "reservation_fee", currency: "USD" }),
  bookingCancelledEmail({ vehicleName: "Kia Picanto", startAt, endAt: atAruba("2026-07-05", "09:00") }),
  adminNewBookingEmail({ vehicleName: "Kia Sportage", startAt, endAt, customerEmail: "a@b.com", paymentOption: "reservation_fee" }),
...
describe("email templates", () => {
  ...
  it("render the rental period as human wall time via formatDateTime, never raw ISO", () => {
    ...
    const confirmed = bookingConfirmedEmail({ vehicleName: "Hyundai Creta", startAt, endAt, rentalTotalCents: 34800, amountPaidCents: 4000, chargeType: "reservation_fee", currency: "USD" });
    ...
    const adminNew = adminNewBookingEmail({ vehicleName: "Kia Sportage", startAt, endAt, customerEmail: "a@b.com", paymentOption: "reservation_fee" });
