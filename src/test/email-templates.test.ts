...
const all = [
  ...
  bookingConfirmedEmail({ vehicleName: "Hyundai Creta", startAt, endAt, rentalTotalCents: 34800, amountPaidCents: 4000, chargeType: "rental_deposit", currency: "USD", paid: true }),
...
describe("email templates", () => {
  it("set a subject and render the key facts", () => {
    ...
    const conf = bookingConfirmedEmail({ vehicleName: "Hyundai Creta", startAt, endAt: atAruba("2026-07-08", "09:00"), rentalTotalCents: 34800, amountPaidCents: 4000, chargeType: "rental_deposit", currency: "USD", paid: true }).html;
  ...
  it("render the rental period as human wall time via formatDateTime, never raw ISO", () => {
    ...
    const confirmed = bookingConfirmedEmail({ vehicleName: "Hyundai Creta", startAt, endAt, rentalTotalCents: 34800, amountPaidCents: 4000, chargeType: "rental_deposit", currency: "USD", paid: true });
